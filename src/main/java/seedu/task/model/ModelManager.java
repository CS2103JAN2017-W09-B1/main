...
public class ModelManager extends ComponentManager implements Model {
    ...
    private List<TaskManager> addressBookStates;
    private TaskManager currentAddressBook;
    ...
    public ModelManager(ReadOnlyTaskManager addressBook, UserPrefs userPrefs) {
        ...
        this.addressBookStates = new ArrayList<TaskManager>();
        this.addressBookStates.add(new TaskManager(addressBook));
        this.currentAddressBookStateIndex = 0;
        this.currentAddressBook = new TaskManager(this.addressBookStates.get(this.currentAddressBookStateIndex));
    ...
    private void recordCurrentStateOfAddressBook() {
        ...
        this.addressBookStates =
                new ArrayList<TaskManager>(this.addressBookStates.subList(0, this.currentAddressBookStateIndex));
        this.addressBookStates.add(new TaskManager(this.currentAddressBook));
    }
    //@@author
    @Override
    ...
    private void indicateAddressBookChanged() {
        raise(new TaskManagerChangedEvent(this.currentAddressBook));
    }
